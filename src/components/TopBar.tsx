                        ...
                        (
                            <div className="flex items-center justify-between px-5 w-screen bg-base-300 h-14">
                                ...
                                {/* Menu Icon */}
                                {
                                    !openNav ?
                                        (
                                            <MdMenu size="32px" className={`duration-200`} onClick={() => (setOpenNav(!openNav))} />
                                        )
                                        :
                                        (
                                            <MdClose size="32px" className={`duration-200`} onClick={() => (setOpenNav(!openNav))} />
                                        )
                                }


                                {/* logo */}
                                {!openSearch && <div className={`flex items-center ml-4 origin-left`}>
                                ...
                                {/* search bar */}
                                {openSearch &&
                                    <div className="relative flex items-center h-8 w-[260px]">
